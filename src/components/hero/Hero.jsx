...
const Hero = () => {
  return (
    <>
      <div className="grid lg:grid-cols-2 lg:py-10 bg-blue-900">
        <div className="col-span-1 flex flex-col gap-4 pt-20 pl-3 sm:ml-10">
          <p className="font-KaushanScript text-3xl text-yellow-400">Explore The</p>
          <p className="font-WorkSans font-bold text-5xl text-white">Travel & Adventures</p>
      ...
      <div className="flex justify-center -mt-40 mb-12 ">
        <div className="grid  xl:grid-cols-5 lg:grid-cols-3 md:grid-cols-2 justify-center items-center gap-3 bg-white  p-6 border rounded-lg ">
          <div>
