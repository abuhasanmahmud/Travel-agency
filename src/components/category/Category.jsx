  ...
  return (
    <div className="bg-slate-100 md:py-14 py-10  ">
      <div className="text-center pb-5">
        <p className="font-KaushanScript lg:text-3xl md:2xl text-blue-900">Browse By Category</p>
        <h2 className="font-WorkSans font-bold lg:text-5xl md:text-4xl sm:text-3xl text-2xl text-blue-950">
          Pick A Tour Type
        </h2>
      </div>
      <div className="grid lg:grid-cols-6 md:grid-cols-3 grid-cols-2 lg:py-10  py-5 ">
        <div className="flex flex-col justify-center items-center rounded-md bg-white px-9 py-6 hover:shadow-xl duration-500">
          ...
          />
          <p className="text-md font-extrabold pt-2 font-WixMadefor text-blue-950">City Tours</p>
        ...
        <div className="flex flex-col justify-center items-center rounded-md bg-white px-10 py-6 hover:shadow-xl duration-500">
          <FontAwesomeIcon
            ...
            className="text-blue-950 bg-yellow-300 p-4 rounded-full"
          />
          <p className="text-md font-extrabold pt-2 font-WixMadefor text-blue-950">Beaches</p>
          <p className="text-sm font-WorkSans text-gray-600">Ten Tours+</p>
        </div>
        <div className="flex flex-col justify-center items-center rounded-md bg-white px-9 py-6 hover:shadow-xl duration-500">
          <FontAwesomeIcon
            ...
            className="text-blue-950 bg-yellow-300 p-4 rounded-full"
          />
          <p className="text-md font-extrabold pt-2 font-WixMadefor text-blue-950">Boat Tours</p>
          <p className="text-sm font-WorkSans text-gray-600">Ten Tours+</p>
        </div>
        <div className="flex flex-col justify-center items-center rounded-md bg-white px-8 py-6 hover:shadow-xl duration-500">
          <FontAwesomeIcon
            ...
            className="text-blue-950 bg-yellow-300 p-4 rounded-full"
          />
          <p className="text-md font-extrabold pt-2 font-WixMadefor text-blue-950">Adventures</p>
          <p className="text-sm font-WorkSans text-gray-600">Ten Tours+</p>
        </div>
        <div className="flex flex-col justify-center items-center rounded-md bg-white px-10 py-6 hover:shadow-xl duration-500">
          <FontAwesomeIcon
            ...
            className="text-blue-950 bg-yellow-300 p-4 rounded-full"
          />
          <p className="text-md pt-2 font-extrabold font-WixMadefor text-blue-950">Food</p>
          <p className="text-sm font-WorkSans text-gray-600">Ten Tours+</p>
        </div>
        <div className="flex flex-col justify-center items-center rounded-md bg-white px-10 py-6 hover:shadow-xl duration-500">
          <FontAwesomeIcon
            ...
            className="text-blue-950 bg-yellow-300 p-4 rounded-full"
          />
          <p className="text-md font-extrabold pt-2 font-WixMadefor text-blue-950">Hiking</p>
          <p className="text-sm font-WorkSans text-gray-600">Ten Tours+</p>
        </div>
      </div>
      <div className="grid lg:grid-cols-2 mx-20 md:py-24 py-14  gap-32">
        <div className="bg-blue-950 flex flex-col items-end">
          <img src="https://i.ibb.co/w635sx7/why-choose-us.webp" alt="" className="w-96 -mt-14" />
          <div className="w-full">
            <p className="text-WorkSans text-start pl-16 text-sm text-white">
              <span className="font-KaushanScript text-4xl text-white text-semibold">10+ </span> Years of
              experience
            </p>
          </div>
        </div>
